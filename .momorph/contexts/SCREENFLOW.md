...
- **Created**: 2026-04-17
- **Last Updated**: 2026-04-23 (batch-generated 14 `screen_specs/*.md` detail files for all outstanding frames + fixed 3 broken relative links to `screen_specs/` siblings)
...
|---|-------------|-----------|---------|--------------|--------|-------------|----------------|----------------|
| 1 | Login | `GzbNeVGJHz` | `662:14387` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/GzbNeVGJHz) | 🟢 shipped | [login.md](screen_specs/login.md) · [spec](../../specs/GzbNeVGJHz-login/spec.md) · [page](../../../src/app/(public)/login/page.tsx) | Supabase `POST /auth/v1/authorize?provider=google`, `GET /auth/callback` | Homepage SAA, Dropdown-ngôn ngữ, Error 403 |
| 2 | Homepage SAA | `i87tDx10uM` | `2167:9026` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/i87tDx10uM) | 🟢 shipped | [homepage-saa.md](screen_specs/homepage-saa.md) · [spec](../../specs/i87tDx10uM-homepage-saa/spec.md) · [design-style](../../specs/i87tDx10uM-homepage-saa/design-style.md) · [page](../../../src/app/page.tsx) | `GET /events/current`, `GET /awards`, `GET /kudos/summary`, `GET /notifications/unread`, `GET /users/me` | Hệ thống giải, Thể lệ UPDATE, Live board, Countdown (pre-launch rewrite), Dropdown-ngôn ngữ, Dropdown-profile, Viết Kudo (FAB) |
| 3 | Countdown – Prelaunch page | `8PJQswPZmU` | `2268:35127` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/8PJQswPZmU) | 🟢 shipped | [countdown.md](screen_specs/countdown.md) · [spec](../../specs/8PJQswPZmU-countdown/spec.md) · [page](../../../src/app/countdown/page.tsx) | `GET /events/current` (env-var sourced for MVP) | Login (at T-0 auto-redirect) |
| 4 | Hệ thống giải | `zFYDgyj_pD` | `313:8436` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/zFYDgyj_pD) | 🟢 shipped | [awards-system.md](screen_specs/awards-system.md) · [spec](../../specs/zFYDgyj_pD-awards-system/spec.md) · [design-style](../../specs/zFYDgyj_pD-awards-system/design-style.md) · [page](../../../src/app/awards/page.tsx) | `GET /awards`, `GET /notifications/unread`, `GET /users/me` | Homepage SAA, Sun* Kudos Live board, Dropdown-ngôn ngữ, Dropdown-profile |
| 5 | Thể lệ UPDATE | `b1Filzi9i6` | _(fetch via MoMorph)_ | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/b1Filzi9i6) | 🟢 shipped | [the-le.md](screen_specs/the-le.md) · [spec](../../specs/b1Filzi9i6-the-le/spec.md) · [page](../../../src/app/the-le/page.tsx) | None (static content, MVP) | Homepage SAA (Đóng), Viết Kudo (CTA) |
| 6 | Sun* Kudos – Live board | `MaZUn5xHXZ` | `2940:13431` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/MaZUn5xHXZ) | 🟢 shipped | [kudos-live-board.md](screen_specs/kudos-live-board.md) · [spec](../../specs/MaZUn5xHXZ-kudos-live-board/spec.md) · [design-style](../../specs/MaZUn5xHXZ-kudos-live-board/design-style.md) · [plan](../../specs/MaZUn5xHXZ-kudos-live-board/plan.md) · [tasks](../../specs/MaZUn5xHXZ-kudos-live-board/tasks.md) · [DEPLOY](../../specs/MaZUn5xHXZ-kudos-live-board/DEPLOY.md) · [page](../../../src/app/kudos/page.tsx) | `GET /kudos`, `GET /kudos?hashtag=…`, `GET /kudos?department=…`, `POST /kudos/:id/hearts` | Viết Kudo, Dropdown Phòng ban, Dropdown Hashtag filter, View Kudo (parked) |
| 7 | Viết Kudo | `ihQ26W78P2` | `520:11602` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/ihQ26W78P2) | 📋 spec'd | [viet-kudo.md](screen_specs/viet-kudo.md) · [spec](../../specs/ihQ26W78P2-viet-kudo/spec.md) · [design-style](../../specs/ihQ26W78P2-viet-kudo/design-style.md) | `createKudo` Server Action (NEW), `searchSunner` (exists), `getKudoHashtags` (exists), Supabase Storage `kudo-images` bucket (NEW) | Live board, Dropdown list hashtag (`p9zO-c4a4x`), Addlink Box (`OyDLDuSGEa`), error variant `5c7PkAibyD` folded as UI state |
| 8 | Dropdown-ngôn ngữ | `hUyaaugye2` | `721:4942` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/hUyaaugye2) | 📋 spec'd (prototype) | [dropdown-ngon-ngu.md](screen_specs/dropdown-ngon-ngu.md) · [spec](../../specs/hUyaaugye2-dropdown-ngon-ngu/spec.md) · [design-style](../../specs/hUyaaugye2-dropdown-ngon-ngu/design-style.md) · [prototype](../../../src/components/login/LanguageDropdown.tsx) | `setLocale` Server Action | Parent: Login, Homepage header, every authenticated screen |
| 9 | Dropdown-profile | `z4sCl3_Qtk` | `721:5223` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/z4sCl3_Qtk) | 🔵 prototype | [dropdown-profile.md](screen_specs/dropdown-profile.md) · [src/components/homepage/ProfileMenu.tsx](../../../src/components/homepage/ProfileMenu.tsx) | `signOut` Server Action | Parent: Authenticated header |
| 10 | Dropdown-profile Admin | `54rekaCHG1` | `721:5277` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/54rekaCHG1) | ⚪ pending (admin) | [dropdown-profile-admin.md](screen_specs/dropdown-profile-admin.md) | `signOut` Server Action | Parent: Admin header (Phase 2) |
| 11 | Dropdown list hashtag | `p9zO-c4a4x` | `1002:13013` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/p9zO-c4a4x) | 📋 spec'd | [dropdown-list-hashtag.md](screen_specs/dropdown-list-hashtag.md) · [spec](../../specs/p9zO-c4a4x-dropdown-list-hashtag/spec.md) · [design-style](../../specs/p9zO-c4a4x-dropdown-list-hashtag/design-style.md) | `getKudoHashtags` (exists) | Parent: Viết Kudo (`ihQ26W78P2`) — opens from "+ Hashtag" button |
| 12 | Dropdown Hashtag filter | `JWpsISMAaM` | _(fetch via MoMorph)_ | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/JWpsISMAaM) | ⚪ pending | [dropdown-hashtag-filter.md](screen_specs/dropdown-hashtag-filter.md) | `GET /hashtags` | Parent: Live board (FilterBar) — popover; select → apply + close, outside / ESC → close, click selected → clear |
| 13 | Dropdown Phòng ban | `WXK5AYB_rG` | `721:5684` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/WXK5AYB_rG) | ⚪ pending | [dropdown-phong-ban.md](screen_specs/dropdown-phong-ban.md) | `GET /departments` | Parent: Live board (FilterBar) — popover sibling of Hashtag filter; click Bộ phận chip → open, select department → apply + close, outside / ESC → close, click selected → clear |
| 14 | Addlink Box | `OyDLDuSGEa` | `1002:12917` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/OyDLDuSGEa) | 📋 spec'd | [addlink-box.md](screen_specs/addlink-box.md) · [spec](../../specs/OyDLDuSGEa-addlink-box/spec.md) · [design-style](../../specs/OyDLDuSGEa-addlink-box/design-style.md) | None (client-side TipTap link-insert dialog) | Parent: Viết Kudo editor — opens from Link toolbar button |
| 15 | Floating Action Button – phím nổi chức năng (collapsed) | `_hphd32jN2` | `313:9137` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/_hphd32jN2) | 🟢 shipped | [fab-collapsed.md](screen_specs/fab-collapsed.md) · [spec](../../specs/_hphd32jN2-fab-collapsed/spec.md) · [design-style](../../specs/_hphd32jN2-fab-collapsed/design-style.md) · [plan](../../specs/_hphd32jN2-fab-collapsed/plan.md) · [page](../../../src/components/shell/QuickActionsFab.tsx) | None | Toggles to `Sv7DFwBw1h` expanded |
| 16 | Floating Action Button – phím nổi chức năng 2 (expanded menu) | `Sv7DFwBw1h` | `313:9139` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/Sv7DFwBw1h) | 🟢 shipped | [fab-quick-actions.md](screen_specs/fab-quick-actions.md) · [spec](../../specs/Sv7DFwBw1h-fab-quick-actions/spec.md) · [design-style](../../specs/Sv7DFwBw1h-fab-quick-actions/design-style.md) · [page](../../../src/components/shell/QuickActionsFab.tsx) | None (pure navigation) | Thể lệ UPDATE, Viết Kudo |
...
| 18 | Onboarding – Complete profile | `ObrdH9pKx7` | _(no Figma — synthetic)_ | — | 🟢 shipped | [onboarding-department.md](screen_specs/onboarding-department.md) · [spec](../../specs/ObrdH9pKx7-onboarding-department/spec.md) · [design-style](../../specs/ObrdH9pKx7-onboarding-department/design-style.md) · [plan](../../specs/ObrdH9pKx7-onboarding-department/plan.md) · [tasks](../../specs/ObrdH9pKx7-onboarding-department/tasks.md) · [page](../../../src/app/onboarding/page.tsx) | `getKudoDepartments` (exists), `completeOnboarding` Server Action (NEW) | Homepage SAA (after submit), Dropdown-ngôn ngữ |
...
| Viết Kudo | `ihQ26W78P2` | 📋 spec'd | Compose a kudo | FAB, header menu, Rules CTA |
...
| Dropdown list hashtag | `p9zO-c4a4x` | 📋 spec'd | Hashtag picker while composing | Viết Kudo |
| Addlink Box | `OyDLDuSGEa` | 📋 spec'd | Link-insert dialog for editor | Viết Kudo |
...
| 2026-04-23 | Batch-generated 14 `screen_specs/*.md` detail files | all outstanding frames | Ran `momorph.screenflow` (via Explore subagent) to distil lightweight discovery docs for every frame that didn't yet have a `screen_specs/*.md` companion. Created: `homepage-saa`, `awards-system`, `kudos-live-board`, `viet-kudo`, `onboarding-department`, `dropdown-ngon-ngu`, `dropdown-profile`, `dropdown-profile-admin`, `dropdown-list-hashtag`, `dropdown-hashtag-filter`, `dropdown-phong-ban`, `addlink-box`, `fab-collapsed`, `fab-quick-actions`. Source = existing `.momorph/specs/{id}-{name}/spec.md` + cross-ref against live `src/app/**` routes and `src/app/kudos/actions.ts` Server Actions. Also fixed 3 broken relative links in the Screens table (`login.md` / `countdown.md` / `the-le.md` now correctly point into sibling `screen_specs/` subfolder). Total 14 files × ~279 lines avg = 3905 new lines; cumulative `screen_specs/` = 17 files × ~282 avg = 4795 lines. `SCREENFLOW.md` itself unchanged structurally — only Detail File column + Discovery Log appended. |
