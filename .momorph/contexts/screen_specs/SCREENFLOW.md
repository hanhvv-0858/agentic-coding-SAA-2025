...
| 11 | Dropdown list hashtag | `p9zO-c4a4x` | `1002:13013` | [Link](https://momorph.ai/files/9ypp4enmFmdK3YAFJLIu6C/screens/p9zO-c4a4x) | 📋 spec'd | [spec](../../specs/p9zO-c4a4x-dropdown-list-hashtag/spec.md) · [design-style](../../specs/p9zO-c4a4x-dropdown-list-hashtag/design-style.md) | `getKudoHashtags` (exists) | Parent: Viết Kudo (`ihQ26W78P2`) — opens from "+ Hashtag" button |
