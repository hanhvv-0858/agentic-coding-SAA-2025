/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3480cd9a496fe65fd4d2c170cc1fcb4b)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		NEXT_PUBLIC_SITE_LAUNCH_AT: string;
		NEXT_PUBLIC_CEREMONY_AT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "ALLOWED_EMAIL_DOMAINS" | "NEXT_PUBLIC_SITE_LAUNCH_AT" | "NEXT_PUBLIC_CEREMONY_AT" | "SUPABASE_SERVICE_ROLE_KEY">> {}
}
